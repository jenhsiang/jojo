...
<nav>
	<div style="top:0px;left:0px;height:70px;background-color:#000000;">
		<div style="float:left"><img src="logo.jpg" style="width:75px;height:70px;"></div>
	...
	<li><a href="#" class="menulink">書籍項目管理</a>
		<ul>	
			<li>
			...
			<li><a href='a_book.jsp' target='incFrame' >書籍管理</a></li>
		</ul>
	</li>
	<li>
	...
	<li>
		<a href='a_borrow_record.jsp' target='incFrame'  class="menulink">借書還書及罰金處理</a>
	</li>
</ul>
...
<div id="container" >
	<iframe name="incFrame" id="incFrame" frameborder=0 width="100%" height="800" src="library.jpg"></iframe>
</div>
</body>
</html>
