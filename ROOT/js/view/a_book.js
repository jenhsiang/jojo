...
Ext.onReady(function() {
  ...
  //deliver_main
    var columns = [
        {header: '書籍編號', dataIndex: 'book_id', renderer: fGridTooltips, sortable: true},
        {header: '書籍名稱', dataIndex: 'book_name', renderer: fGridTooltips, sortable: true},
		{header: '書籍圖片', dataIndex: 'book_img', renderer: fGridTooltips, sortable: true},
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [{ 
                ...
                store : Ext.create('Ext.data.Store',{ 
                    fields : ['name','value'], 
                    data : [{'name':'書籍名稱','value':'book_name'},
