			...
			if(!returnMessage.equals("5")){
					...
					if(result == 1){
						...
						if(totalresult == 1){
							...
							boolean check = false;	
							if(sql_status.equals("insert")){
								check =	mail.sendmail( member_email + ",ed01039639@gmail.com", "看啥租啥--租書通知(" + member_name +")", mailcontect,2);
							}else if(sql_status.equals("delete")){
								check =	mail.sendmail( member_email + ",ed01039639@gmail.com", "看啥租啥--取消預約通知(" + member_name +")", mailcontect,5);
							}								
								if(check)
									returnMessage = "2";
								else
